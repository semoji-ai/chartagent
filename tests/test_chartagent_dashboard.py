...
class ChartAgentDashboardTests(unittest.TestCase):
    def test_write_chartagent_dashboard_writes_index_and_case_artifacts(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("ChartAgent Style Lab", index_html)
            self.assertIn("Theme Lab", index_html)
            self.assertIn("Static Audit", index_html)
            self.assertIn("Open dedicated theme gallery", index_html)
            ...
            self.assertIn('id="lab-theme-filter"', index_html)
            self.assertIn('id="lab-family-filter"', index_html)
            self.assertIn('id="lab-visible-theme-count"', index_html)
            self.assertIn('id="lab-visible-card-count"', index_html)
            self.assertIn('data-global-variant="signal"', index_html)
            ...
            self.assertIn('class="details-grid"', index_html)
            self.assertIn("Raw Artifacts", index_html)
